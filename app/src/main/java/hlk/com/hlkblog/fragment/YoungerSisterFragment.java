...
public class YoungerSisterFragment extends BaseFragment {
...
//        http://gank.io/api/data/福利/10/1
        ...
        HttpUtils.get("http://jandan.net/?oxwlxojflwblxbsapi=jandan.get_ooxx_comments&page=" + page, new StringCallback() {
            @Override
